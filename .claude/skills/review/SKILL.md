---
name: review
description: Cross-model code review — Gemini reviews Claude's diff for scope creep, dead code, naming, missed requirements
---
...
**Fallback chain:** `gemini-3-flash-preview` → `gemini-3-pro-preview` → `gemini-2.5-pro`
...
**Fallback chain:** `gemini-3-pro-preview` → `gemini-3-flash-preview` → `gemini-2.5-pro`
