...
- [ ] `[P1]` `[AI-CLI-1]` **Fix lint + test failures and ship v0.1.1** — 13 ruff lint issues + 7 test failures from professionalization refactor. Fix all, bump to v0.1.1, tag, push to trigger auto-publish to PyPI via Trusted Publishers. Delegated to c-r-ai-cli-1 session.
